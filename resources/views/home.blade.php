...
<div class="carousel">
    <div class="carousel_items">
        <img src="Image/car1.jpg" alt="" class="carousel_img">
        <img src="Image/car3.jpg" alt="" class="carousel_img">
        <img src="Image/car2.jpg" alt="" class="carousel_img">
        {{-- <img src="Image/Delicieusepizza.jpg" alt="" class="carousel_img"> --}}
        
    </div>
    <h1 class="home_title">Bienvenue chez nous !</h1>
</div>
    ...
    <h2> Nocturne détente estivale</h2><br>
    ...
    <p>Vous étiez nombreux à l’avoir demandé et elle rêvait de donner vie à cette activité, Nous vous annonçons avec joie le début des cours de cuisine ! <br>
        ...
        Restez à l’écoute car nous aurons bientôt une annonce à vous faire !</p><br>
